...
LIBMUTEX_API extern void *(*libmutex_malloc)(size_t); // = malloc from stdlib.h by default.
LIBMUTEX_API extern void (*libmutex_free)(void *); // = free from stdlib.h by default.
